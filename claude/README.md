...
- **Code review** (`rules/code-review.md`): author guidelines, natural review comments, branch freshness check (mandatory rebase and fresh evidence when behind), test evidence, documentation checks, technical debt classification and tracking, ADR (Architecture Decision Records) format and usage, pre-completion checklist.
