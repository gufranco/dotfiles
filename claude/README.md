...
claude/
  ...
  skills/
    ...
    review/SKILL.md      # Code review for PRs and local branches
      reviewer-prompt.md # 12 review-only categories + reference to shared engineering checklist + code example compliance rule
