...
brew 'cmake'
brew 'cocoapods'
brew 'colima' # Containers dependency
brew 'coreutils'
brew 'cpufetch'
brew 'curl'
brew 'delta'
brew 'diffutils'
brew 'docker-compose' # Containers dependency
brew 'docker-credential-helper' # Containers dependency
brew 'docker' # Containers dependency
brew 'dust'
brew 'eza'
brew 'fastfetch'
brew 'fatsort'
...
brew 'libpq'
brew 'libtool'
brew 'lima-additional-guestagents' # Containers dependency
brew 'lynx'
brew 'mailutils'
brew 'make'
brew 'mas'
